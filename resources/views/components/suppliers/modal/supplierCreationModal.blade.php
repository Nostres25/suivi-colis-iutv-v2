...
@php
    ...
    $canCreateSupplier = in_array('Service financier', $roleNames) || in_array('Administrateur BD', $roleNames);
@endphp
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <div class="d-flex justify-content-start" title="Marquer qu'il est possible de passer commande avec ce fournisseur">
                       <input class="form-check-input me-2" type="checkbox" id="checkboxValidate" name="isValid" form="addSupplierForm" checked>
