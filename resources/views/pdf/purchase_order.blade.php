...
<head>
    <meta charset="UTF-8">
    <title>Bon de commande {{ $order->getOrderNumber() }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .signature-box { display: table-cell; width: 50%; padding: 10px; }
        .signature-box h3 { font-size: 11px; text-transform: uppercase; color: #7f8c8d; margin-bottom: 40px; }
...
<body>
    ...
    <div class="header">
        <div class="header-left">
            ...
            <div class="doc-number">N° {{ $order->getOrderNumber() }}</div>
            <div class="info-block">
                ...
                @endif
                @if($order->getSupplier()->getAttribute('contact_name'))
                    <p>Contact : {{ $order->getSupplier()->getAttribute('contact_name') }}</p>
                @endif
            </div>
        </div>
        <div class="header-right">
            ...
            @if($order->getQuoteNumber())
                <div class="info-block">
                    <h3>Reference Devis</h3>
                    <p>{{ $order->getQuoteNumber() }}</p>
                </div>
            @endif
        </div>
    </div>
